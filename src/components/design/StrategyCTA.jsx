    ...
    <section className="relative bg-gradient-to-br from-gray-900 to-black py-16 sm:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button className="border-2 border-gray-700 hover:border-emerald-500 text-gray-300 hover:text-emerald-400 font-semibold py-4 px-8 rounded-full transition-all duration-300">
            Talk to an Expert
          </button>
        </div>
      </div>
