        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-end">
          {packages.map((pkg, index) => (
            ...
            >
              {/* Featured ribbon */}
              {pkg.featured && (
                <div className="absolute top-0 right-0 bg-orange-500 text-white text-xs font-bold px-4 py-1 transform rotate-45 translate-x-8 -translate-y-2 w-40 text-center">
                  MOST POPULAR
                </div>
              )}
