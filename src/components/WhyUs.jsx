      ...
      <div className="relative max-w-5xl mx-auto">
          ...
          <div className="bg-gray-50 rounded-xl p-6 text-center border border-gray-200">
            <div className="flex justify-center mb-4">
              <div className="bg-orange-100 p-3 rounded-full">
                <CheckCheckIcon className="h-8 w-8 text-orange-600" />
              </div>
            </div>
        ...
        <div className="bg-emerald-50 rounded-2xl p-8 md:p-10 border border-emerald-100">
          <div className="flex items-start">
            <svg className="h-8 w-8 text-orange-500 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="ml-4">
              ...
              <div className="flex items-center">
                ...
                />
                <div className="ml-4">
                  <p className="font-bold text-gray-900">Miriam M</p>
